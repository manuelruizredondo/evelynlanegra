...
export const ui = {
  es: {
    ...
    waitlist: {
      ...
      note: "Estoy preparando el curso online de bachata tradicional. Déjame tu email y serás de las primeras personas en saber cuándo abre, con las condiciones de lanzamiento.",
  ...
  it: {
    ...
    waitlist: {
      ...
      note: "Sto preparando il corso online di bachata tradizionale. Lasciami la tua email e sarai tra i primi a sapere quando apre, con le condizioni di lancio.",
